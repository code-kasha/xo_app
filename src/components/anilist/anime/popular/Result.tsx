import { PopularResult } from "../../../../types/anime/anilist"

import Image from "../../../core/Image"

import { Link } from "react-router-dom"

export default function Result({ result }: { result: PopularResult }) {
	...
	return (
		<div key={id} className="space-y-2 pb-3">
			...
			<div className="text-center w-9/12 mx-auto">
				<p className={`truncate pb-2 p-1 font-bold`} title={title}>
					{title}
				</p>
